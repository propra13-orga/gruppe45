...
public class ShopFrame extends JFrame {
    ...
    public ShopFrame(){
       ...
       //Bugs Player 1
        ...
        labelB = new JLabel (String.valueOf(new Integer(local.Create.hero1.getBugs())));
        labelB.setBounds(100,100,50,50);

        JLabel klabel1_b = new JLabel ("HP:");
        klabel1_b.setBounds(50, 120, 50, 50);
        
        labelHP = new JLabel (String.valueOf(new Integer(local.Create.hero1.getHp())));
        labelHP.setBounds(100,120,50,50);
        
        JLabel labelMP_a = new JLabel("MP:");
        labelMP_a.setBounds(50,140,50,50);
        
        labelMP = new JLabel(String.valueOf(new Integer(local.Create.hero1.getMp())));
   ...
   //     kLabel2.setBounds(200,150,200,50);
        ...
        hButton1.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                if (local.Create.hero1.getBugs()< 1){
                       noBugs();
                }
                else{
                	int hp = 10;
...
public void updatePoints(int index){
	...
	{
		case 1: {//change Bugs
					labelB.setText(String.valueOf(new Integer(local.Create.hero1.getBugs())));
				}break;
		case 2: {//change HPs
					labelHP.setText(String.valueOf(new Integer(local.Create.hero1.getHp())));
				}break;
		case 3: {//changes MPs
			       labelMP.setText(String.valueOf(new Integer(local.Create.hero1.getMp())));
				}break;
